...
<div id="content">
    <div class="container">
        ...
        <div class="col-lg-3">
                ...
                <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills flex-column text-sm category-menu">
                            <li class="nav-item"><a href="shop-category.html" class="nav-link d-flex align-items-center justify-content-between"><span>Men
                            ...
                            <li class="nav-item"><a href="shop-category.html" class="nav-link active d-flex align-items-center justify-content-between"><span>Ladies
                            ...
                            <li class="nav-item"><a href="shop-category.html" class="nav-link d-flex align-items-center justify-content-between"><span>Kids
                ...
                <div class="panel panel-default sidebar-menu">
                    <div class="panel-heading d-flex align-items-center justify-content-between">
                        <h3 class="h4 panel-title">Brands</h3><a href="#" class="btn btn-sm btn-danger"><i class="fa fa-times-circle"></i><span
                                class="d-none d-md-inline-block">Clear</span></a>
                    </div>
                    <div class="panel-body">
                        <form>
            ...
            <div class="col-lg-9">
                <p class="lead">Built purse maids cease her ham new seven among and. Pulled coming wooded tended it
                    answer remain me be. So landlord by we unlocked sensible it. Fat cannot use denied excuse son law.
                    Wisdom happen suffer common the appear ham beauty her had. Or belonging zealously existence as by
                    resources.</p>
                ...
                <div id="productMain" class="row">
                    <div class="col-sm-6">
                        <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                            <div> <img src="img/ps3.jpg" alt="" class="img-fluid"></div>
                            <div> <img src="img/ps3.jpg" alt="" class="img-fluid"></div>
                            <div> <img src="img/ps3.jpg" alt="" class="img-fluid"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div data-slider-id="1" class="owl-thumbs">
                            <button class="owl-thumb-item"><img src="img/ps3.jpg" alt="" class="img-fluid"></button>
                            <button class="owl-thumb-item"><img src="img/ps3.jpg" alt="" class="img-fluid"></button>
                            <button class="owl-thumb-item"><img src="img/ps3.jpg" alt="" class="img-fluid"></button>
                        </div>
                    </div>
                ...
                <div id="details" class="box mb-4 mt-4">
                    ...
                    <blockquote class="blockquote">
                        <p class="mb-0"><em>Define style this season with Armani's new range of trendy tops, crafted
                                with intricate details. Create a chic statement look by teaming this lace number with
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product">
                            <div class="image"><a href="#"><img src="img/ps3.jpg" alt="" class="img-fluid image1"></a></div>
                            <div class="text">
                                <h3 class="h5"><a href="detalhes_item.php">Fur coat</a></h3>
                                <p class="price">$143</p>
                            </div>
                        </div>
                    </div>
